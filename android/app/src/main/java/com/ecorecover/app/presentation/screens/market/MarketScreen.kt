...
fun MarketScreen(
    ...
    val uiState by viewModel.prices.collectAsStateWithLifecycle()
        ...
        Column(
            ...
            when (val state = uiState) {
                ...
                is UiState.Success -> {
                    ...
                    val metals = state.data.entries.toList()
                    ...
                    LazyColumn(
                        ...
                        items(metals) { entry ->
                            ...
                            val name = entry.key
                            val metal = entry.value

                            MetalPriceItem(

                                name = name,

                                price = "₹${String.format("%.2f", metal.price_inr_per_g)}/g",

                                change = metal.daily_percent
